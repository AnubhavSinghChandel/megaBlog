...
function Footer() {
    return (
        <footer className="bottom-0 w-full text-center text-white dark:bg-neutral-900">
            ...
            {/* <!--Copyright section--> */}
            <div
                className="bg-neutral-300 flex gap-2 justify-center p-4 text-center text-neutral-700 dark:bg-neutral-800 dark:text-neutral-200">
                © 2023 Copyright:<p className="dark:text-neutral-400">{" "}megaBlog</p>
            </div>
        </footer>
    );
}
